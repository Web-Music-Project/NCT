...
namespace Web_Music.GUI.Admin
{
    public partial class ThemBaiHat : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ddl_Artist.DataSource = bus_artist.GetAllSinger();
        ...
        protected void btnThem_Click(object sender, EventArgs e)
        {
            ...
            bus_song.AddSong(txtTenBaiHat.Text.Trim(), txtLyric.Text.Replace("'","''"), upload_thumnail.FileName, upload_music.FileName, int.Parse(ddl_Artist.SelectedValue), int.Parse(ddl_Category.SelectedValue));
        }
    }
}