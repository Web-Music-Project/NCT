...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="dgvbaihat" AllowPaging="True" PageSize="20" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="1000px"  HorizontalAlign="Center" Font-Size="18px" OnPageIndexChanging="dgvbaihat_PageIndexChanging">
        <AlternatingRowStyle BackColor="White" />
        <Columns>
            <asp:BoundField HeaderText="ID" DataField="ID" />
            <asp:BoundField HeaderText="Tên Bài Hát" DataField="Name" />
            <asp:BoundField HeaderText="Ca sĩ" DataField="Name1" />
            <asp:BoundField HeaderText="Thể loại" DataField="Name2" />
