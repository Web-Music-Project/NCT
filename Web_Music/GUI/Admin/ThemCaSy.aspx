...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <asp:Table runat="server" Width="457px" CellPadding="10" Font-Size="14px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell><asp:FileUpload ID="upload_avatar" runat="server"/></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>Giới Thiệu</asp:TableCell>
            <asp:TableCell><asp:TextBox runat="server" ID="txtgioithieu" Width="300"  Height="150px" TextMode="MultiLine" Columns="50" Rows="10"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
